...
export default function Cart({ cartItems, setCartItems }) {
    ...
    return  cartItems.length > 0 ? <Fragment>
            ...
            </Fragment>: ( !complete ? <h2 className="mt-5"> <b>Your Cart is Empty!! </b> </h2> : <Fragment> <h2 className="mt-5"> <b>Order Complete!!</b></h2><p>Your Order has been Place Successfully.</p></Fragment>)
}
